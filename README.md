...
See `/docs/` for the full ER diagram image and the dbdiagram.io link.
...
|
|-- docs/
|   |-- Phase1_Proposal.pdf        # Original Phase 1 APA proposal
|   |-- dbdiagram_schema.dbml      # DBML schema for dbdiagram.io
|   `-- er_diagram.png             # ER diagram exported from dbdiagram.io
|
|-- migrations/
...
| DBDiagram Schema | *(paste your shared dbdiagram.io link here)* |
| Cloud Demo Video | *(paste your Supabase screen recording link here)* |
